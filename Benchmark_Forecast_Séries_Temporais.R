...
ui <- fluidPage(
    ...
    fluidRow(
        column(4,
               ...
               helpText("O arquivo deve conter apenas uma coluna, sem nome
                        no cabeçalho. A frequência deve ser mensal")),
        column(4,
               dateRangeInput("datas",label="Período da série",format="mm/yyyy",
...
server <- function(input, output) {
    ...
    observeEvent(input$Processar, {
        ...
        output$GrafPrev = renderPlot({
            ...
            lines(Mholt$mean, type="l", pch=22, lty= 3, col="brown", lwd=2)
            ...
            legend("bottomleft", legend = c("Naive","Mean","Dri.","Hol.",
                                            "Hw","HwM","HwMD","Ari.",
                                            "Lm","RNA"),
                   col = c("red","blue","green","brown","slateblue4","purple",
                           "orangered3","skyblue4","cyan","salmon"),
